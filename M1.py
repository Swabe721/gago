...
def generate_user_agent():
    ...
    if is_win64:
        user_agent = (f"Mozilla/5.0 (Windows NT {windows_version}.0; Win64; x64) AppleWebKit/{webkit_version}.0 (KHTML, like Gecko) Chrome/{chrome_version}.0.0.0 Safari/{safari_version}.0")
    else:
        user_agent = (f"Mozilla/5.0 (Windows NT {windows_version}.0; WOW64) AppleWebKit/{webkit_version}.0 (KHTML, like Gecko) Chrome/{chrome_version}.0.0.0 Safari/{safari_version}.0")  
    return user_agent
...
def uafile():
    ...
    jz_value = ''.join(random.choice('0123456789') for _ in range(5))
    ua = f"Dalvik/2.1.0 (Linux; U; Android {android_version}; CPH1979 Build/RP1A.{jz_value}.011) [FBAN/Orca-Android;FBAV/{fbav};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{fbbv};FBCR/null;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1979;FBSV/{android_version};FBCA/arm64-v8a:null;FBDM/{{density=2.0,width=1424,height=720}};FB_FW/1;]"
    return ua
...
slow_print("'\x1b[1;94m'Welcome to S Y T H E  Tools ", delay=0.15)
slow_print("      \033[96;1m   Loading  Please Wait • • • ", delay=0.01)
slow_print(" '\x1b[1;31m  This Tools Is strictly 1 device only , Purchase a full script to use Multiple Devices ", delay= 0.02)
slow_print (" '\x1b[1;31m  ████████████████████████████ \x1b[1;32m10%", delay=0.01)
slow_print (" '\x1b[1;31m  █████████████████████████████\x1b[1;32m 20%", delay=0.01)
slow_print ("'\x1b[1;31m   ██████████████████████████████\x1b[1;32m 30%", delay=0.01)
slow_print (" '\x1b[1;31m  ███████████████████████████████\x1b[1;32m 40%", delay=0.01)
slow_print ("  '\x1b[1;31m ████████████████████████████████\x1b[1;32m 50%", delay=0.01)
slow_print (" '\x1b[1;31m  █████████████████████████████████\x1b[1;32m 60%", delay=0.01)
slow_print (" '\x1b[1;31m  ██████████████████████████████████\x1b[1;32m 70%", delay=0.01)
slow_print (" '\x1b[1;31m  ███████████████████████████████████\x1b[1;32m 80%", delay=0.01)
slow_print (" '\x1b[1;31m  ████████████████████████████████████\x1b[1;32m 90%", delay=0.01)
slow_print (" '\x1b[1;31m. █████████████████████████████████████\x1b[1;32m 100%", delay=0.01)


slow_print (" '\x1b[1;32m'.   SUCCESSFULLY ACCESS", delay=0.02)
def logo():
	print(f"""\x1b[1;34m
     ███████╗░█████╗░██████╗░░██████╗░█████╗░██╗░░░░░███████╗
     ██╔════╝██╔══██╗██╔══██╗██╔════╝██╔══██╗██║░░░░░██╔════╝
...
───────────────────────────────────────────────────────────────────
    {LGN}               A P P R O V A L   S Y S T E M
   {S}                          
                ╔═══╗───────────╔╗
                ║╔═╗║──────────╔╝╚╗
                ║╚══╦══╦══╦╗╔╦═╬╗╔╬╗─╔╗
...
\x1b[1;37m                       KEY   :  {S}{key}
""")
        print("'           YOU NEED APPROVAL TO ACCESS  THIS TOOL")
        time.sleep(0.5)
        urls = [
        ...
        for url in urls:
            ...
            if key in approval_data:
                linex()
                print(f"                 {R}           TAKE NOTE : ")
                print(f"{H}            YOUR KEY HAS BEEN {P}SUCCESSFULLY {G} APPROVED !!! ")
                print (f"      {R}❯{Y}❯{H}❯{W}❯ {S}ADMIN SYTHE IS APPROVED YOUR TOOL ACCESS ")
                linex()
                time.sleep(3)
                return key        
...
{YELLOW}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
{G} ⊂⊃ {R}𝗨𝘀𝗲𝘀               {G}⊂⊃ {R}Boosting Tools
{G} ⊂⊃ {R}𝗧𝗼𝗼𝗹𝘀              {G}⊂⊃ {R}Paided 
{G} ⊂⊃ {R}𝗩𝗲𝗿𝘀𝗶𝗼𝗻            {G}⊂⊃ {R}▮▮▮▮•▮▯▯ 6.2
{RED}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
#########LOGO REACT##########
logo_react=(f"""{R}                
...
{G} ⊂⊃ {R}𝗧𝗼𝗼𝗹𝘀              {G}⊂⊃ {R}Paided 
{G} ⊂⊃ {R}𝗩𝗲𝗿𝘀𝗶𝗼𝗻            {G}⊂⊃ {R}▮▮▮▮•▮▯▯ 6.2
{G} NOTE : Always Use big letter REACTION example {R} ( LOVE , HAHA , ANGRY , SAD , LIKE , )
{RED}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
#########LOGO COMMENT#######
logo_cmnt=(f"""{R}                
{YELLOW}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
    ...
    try:
        ...
        if y == ("***"):
            if os.path.isfile("token_zari.txt"):
                status = (f"{R} Account Log in  ")
            else:
                status = (f"{R}No account")
                print(f'{W}│                                                                   │')
            print(f'{W}    ╰─────────  {S}Facebook account : {G}【{status}{G}】{W}─────────╯')
            if os.path.isfile("token_zari.txt"):
                status = (f" {G } ᯤ ")
            linex()
            print(f' {W}╭───────────────────────────────────────────────────────────────────╮')
            print(f'{W} │                     {S}〘 𝐓𝐎𝐎𝐋𝐒 𝐒𝐄𝐑𝐕𝐈𝐂𝐄𝐒 〙{W}                          │  ') 
            print(f' {W}╰───────────────────────────────────────────────────────────────────╯')
            print(f' {W}   │   {S}[ 01 ]{R} {R} {G}LOG IN {R}              {W}- {R}[ {H} FACEBOOK LOGIN {R}]{W}        │')
            print(f' {W}   │   {S}[ 02 ]{G} {R} {W}AUTO SHARE{R}           {W}- {R}[ {H} COOKIE LOG IN{R}  ]{W}        │')
            print(f' {W}   │   {S}[ 03 ]{G} {R} {W}AUTO COMMENTS {R}       {W}- {R}[ {H}PAGE OR ACCOUNT{R} ] {W}       │')
            print(f' {W}   │   {S}[ 04 ]{G} {R} {W}AUTO REACT {R}          {W}- {R}[ {H}PAGE OR ACCOUNT{R} ] {W}       │')
            print(f' {W}   │   {S}[ 05 ]{G} {R} {W}AUTO FOLLOW {R}         {W}- {R}[ {H}PAGE OR ACCOUNT{R} ]  {W}      │')
            print(f' {W}   │   {S}[ 06 ]{G} {G} {G}REMOVE TOKEN {R}        {W}- {R}[ {H} DELETE TOKEN{R}   ] {W}       │')
            print(f' {W}   │   {S}[ 07 ]{G} {R} EXIT {R}                {W}- {R}[ {H}   EXIT HERE  {R}  ] {W}       │')
            print(f' {W}   │   {S}[ 08 ]  {R}INSTRUCTIONS {R}        {W}- {R}[ {H}   GUIDE HERE {R}  ]{W}        │')
            print(f' {W}   │   {S}[ 09 ]{R} {R} ACCOUNT {R}             {W}- {R}[ {H}   CHECKER {R}     ] {W}       │')
            print(f' {W}   ╰─────────────────────────────────────────────────────────────╯ ')
            linex()
            opt = input(f'{G} CHOOSE : ')
            linex()
            #####AUTO SHARE######
            if opt in ['1','01']:
                if os.path.isfile("token_zari.txt"):
            ...
            #####AUTO COMMENT######
                ...
                try:
                    ...
                    print(f"{B}Error: {e}")
                print(f"{G}              AVAILABLE FB PAGES - {total_pages}")
                print(f"{G}              AVAILABLE FB ACCOUNT - {len(add_token)}")
                print(f"{G}[1] EXIT")
                linex()
                method = input(f"{R}Choose: ")
                linex()
...
def get_file_path():
    while True:
        print(f"{G}Ex: /sdcard/email.txt ")
        linex()
        file_path = input(f"{G}Enter File Path: ")
        linex()
...
def login():
	os.system("clear")
	print(logo_share)
	cookie = input(f"{G} input Cookie {R} : ")
	linex()
	try:
		...
		print(f"         {S} COOKIE'S {G} LOGIN SUCCESSFULLY");time.sleep(2)
		bot_share()
	except:
...
def bot_share():
    ...
    try:
        ...
        os.system("rm token.txt cookie.txt > /dev/null 2>&1")
        print(f"{R}Invalid cookie");time.sleep(1)
        login()
    os.system('clear')
    print(logo_share)
    link = input(f" {R} Post link {G} : ")
    linex()
    lmt = int(input(f"{P} How Many share?  : "))
    linex()
    try:
        n = 0
        ...
        for x in range(lmt):
            ...
            if "id" in post:
                print(f" {R}        𝐒𝐇𝐀𝐑𝐄𝐃 {Y}𓊆 {P} 𝐂𝐎𝐔𝐍𝐓 {Y} 𓊇{R} ╰┈➤{W} [{x+1}]")
                print(f"{G}        {R}━━━━⊱   {G}𝐒 𝐔 𝐂 𝐂 𝐄 𝐒 𝐒 𝐅 𝐔 𝐋 𝐋 𝐘  𝐒 𝐄 𝐍 𝐓   {R} ⊰━━━━  ")
                linex()
            else:
...
def perform_reaction_acc(post_id, reaction_type, reaction_limit=1):
    ...
    try:
        ...
        for access_token in add_token:
            ...
            if response.status_code == 200:
                total_reactions_sent += 1
                print(f"{R}╰┈➤ {G} SUCCESSFULLY {R} REACTED {G}{post_id} ")
                print(f" {G}            {G} TOOLS ID {R} [344-6789 ]{G} 6.0 {R}Version ")
                linex()
                time.sleep(2)
                if total_reactions_sent >= reaction_limit:
                ...
                print(f"{M}FAILED TO POST REACTION  | {post_id} ")
                linex()
    except requests.exceptions.RequestException as error:
        print(f"{error}")

...
slow_print("'\x1b[1;94m'Welcome to RVBOOSTING TOOL ", delay=0.01)
...
{W}┌─── {G}❏ {Y}❏ {O}❏ {W}❏────────{S}TOOLS INFORMATION{W}───────────────────────────────────┐
{W}│  {G}❯ {R}Uses     : {G}Boosting            {red}  ➙{white} Lifetime access          {W}       │
{W}│  {G}❯ {R}Status   : {G} Active              {red} ➙ {white}No monthly Fee              {W}    │
{W}│  {G}❯ {R}Tools    : {G}Paided/Premium       {red} ➙{white} Fast Process             {W}       │
{W}│  {G}❯ {R}Network  : {G} All Network          {red}➙ {white}Customizable             {W}        │
{W}│                                                   {red}    version {G}7.0   {white} {W} │
{W}└───────────────────────────────────────────────────── {G}❏ {Y}❏ {O}❏ {W}❏──────────┘
...
def count_lines_in_files(*file_paths):
    for i, file_path in enumerate(file_paths, start=1):
        try:
            ...
            if i == 1: 
                print(f'''\t\t{W}        │ {P} FRA ACCOUNT {R}: {green}{total_lines} {P} │''')
            elif i == 2:
                print(f'''\t\t{W}        │ {P} RPA ACCOUNT {R}: {green}{total_lines} {P} │''')
            elif i == 3:
                print(f'''\t\t{W}        │ {P} FRA PAGES   {R}: {green}{total_lines}  {P}│''')
            elif i == 4:
                print(f'''\t\t{W}        │{P}  RPA PAGES   {R}: {green}{total_lines}  {P}│''')
            elif i == 5:
            	print(f'''\t\t{W} ━━━━━━━━━━━━━━━ ''')
